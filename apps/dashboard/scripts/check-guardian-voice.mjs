...
requireText(page, 'updateVoiceState("thinking")', "Thinking avatar state is missing.");
requireText(page, 'updateVoiceState("speaking")', "Speaking avatar state is missing.");
