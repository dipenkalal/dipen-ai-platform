...
class AgentAnalyticsRepository:
    ...
    def get_overview(
        ...
        total_runs = self._as_int(
            totals_row["total_runs"] if totals_row else 0
        )

        completed_runs = self._as_int(
            totals_row["completed_runs"] if totals_row else 0
        )
        ...
        return AnalyticsOverview(
            ...
            failed_runs=self._as_int(
                totals_row["failed_runs"] if totals_row else 0
            ),
            running_runs=self._as_int(
                totals_row["running_runs"] if totals_row else 0
            ),
            ...
            runs_today=self._as_int(
                totals_row["runs_today"] if totals_row else 0
            ),
            most_used_agent=(
                str(most_used_row["agent_id"]) if most_used_row else None
            ),
        )
