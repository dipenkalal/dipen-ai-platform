...
class CooperativeCancellationRuntimeTests(unittest.IsolatedAsyncioTestCase):
    async def test_probe_cancels_instrumented_task_before_raw_dispatch(self) -> None:
